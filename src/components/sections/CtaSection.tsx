      ...
      <div
        ...
        style={{
          background:
            ...
            "linear-gradient(to left, var(--color-shab-deep) 18%, color-mix(in srgb, var(--color-shab-deep) 88%, transparent) 46%, color-mix(in srgb, var(--color-shab-deep) 40%, transparent))",
        }}
      />
