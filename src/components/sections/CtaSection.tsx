      ...
      <div
        ...
        style={{
          background:
            ...
            "linear-gradient(to left, var(--color-makhmal-deep) 18%, color-mix(in srgb, var(--color-makhmal-deep) 88%, transparent) 46%, color-mix(in srgb, var(--color-makhmal-deep) 40%, transparent))",
        }}
      />
